  ...
  return (
    <div className="max-w-[1600px] mx-auto">
      <header className="flex justify-between items-center mb-6 pb-4 border-b border-slate-200">
        <div>
          <h1 className="text-2xl font-black text-slate-900 uppercase tracking-tighter italic">Agenda</h1>
          <p className="text-[10px] text-slate-400 font-bold mt-0.5 italic">Compromissos e agendamentos</p>
        </div>
      </header>

  ...
  return (
    <div className="max-w-[1600px] mx-auto">
      ...
      <div className="flex justify-between items-center mb-4 px-2">
        <div className="text-zinc-500 text-sm uppercase font-black bg-slate-100/50 px-3 py-1 rounded-full border border-slate-200 tracking-tighter shadow-xs italic">
      ...
      <div className="w-full bg-white border border-slate-100 rounded-2xl shadow-floating overflow-hidden mb-6">
        <div className="overflow-x-auto w-full scrollbar-thin scrollbar-thumb-slate-200 scrollbar-track-transparent">
          <div className="min-w-[1100px] w-full">
            <div className="grid grid-cols-[120px_3fr_2fr_2fr_2fr_1.2fr_1.2fr] gap-3 py-3 bg-slate-50/50 border-b border-slate-100 text-slate-500 font-black text-sm uppercase px-4 italic tracking-tighter">
              <div>Número</div>
              <div>Lead</div>
              <div>Contato</div>
              <div>Responsável</div>
            ...
            {loading && (
              <div className="flex flex-col items-center justify-center py-16 gap-3">
                ...
                <p className="text-slate-400 font-black text-sm uppercase animate-pulse">Sincronizando base...</p>
              </div>
            )}
            ...
            {!loading && orcamentos.length === 0 && (
              <div className="text-center py-20">
                ...
                <p className="text-slate-400 font-black text-sm uppercase">Nenhum orçamento encontrado.</p>
            ...
            {!loading &&
              orcamentos.map((orc) => {
                ...
                return (
                  ...
                  >
                    <div className="truncate font-black text-sky-600 tracking-tighter text-sm uppercase" title={orc.numero}>
                      {orc.numero}
                    </div>
                    ...
                    <div className="truncate" title={lead.vendedor?.nome}>
                      <span className="bg-slate-50 px-2 py-0.5 rounded-xl text-sm font-black text-slate-400 border border-slate-100 group-hover:bg-white group-hover:text-slate-600 group-hover:border-slate-200 transition-all uppercase tracking-tighter">
                        {lead.vendedor?.nome || '—'}
                      </span>
                    </div>
                    ...
                    <div className="truncate text-slate-400 font-bold text-sm uppercase tracking-tighter">

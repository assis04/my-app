  ...
  if (!orcamento) {
    return (
      <div className="max-w-[900px] mx-auto">
        <div className="bg-rose-50 border border-rose-100 text-rose-600 p-3 rounded-2xl text-base flex items-start gap-2 shadow-sm mt-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="space-y-1.5">
            ...
            {isCancelado && orcamento.motivoCancelamento && (
              <p className="text-sm text-rose-600 font-bold px-1 mt-1">
      ...
      <div className="glass-card border border-white/60 rounded-3xl p-6 shadow-floating bg-white/40 backdrop-blur-xl mb-6">
        ...
        <div className="mt-4">
          <button
            ...
            className="inline-flex items-center gap-1.5 text-base font-bold text-sky-600 hover:text-sky-700 transition-all"
          >

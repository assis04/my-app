  ...
  return (
    <div className="max-w-[1600px] mx-auto">
      <header className="flex justify-between items-center mb-6 pb-4 border-b border-(--border)">
        <div>
          <h1 className="text-2xl font-black text-(--text-primary) tracking-tight">Vendas</h1>
          <p className="text-xs text-(--text-muted) font-bold mt-0.5">Gestão de vendas e pedidos</p>
        </div>
      </header>

  ...
  return (
    <div className="flex flex-wrap justify-between items-center gap-3 mb-4 border-b border-(--border-subtle) pb-3">
      <div className="min-w-0">
        <h1 className="text-xl sm:text-2xl font-black text-(--text-primary) tracking-tight">{title}</h1>
        {subtitle && <p className="text-xs text-(--text-muted) font-bold mt-0.5">{subtitle}</p>}
      </div>

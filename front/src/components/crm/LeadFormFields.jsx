  ...
  return (
    <>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            <label className="text-xs font-black text-slate-400 px-1 uppercase tracking-tighter">Nome *</label>
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-black text-slate-400 px-1 uppercase tracking-tighter">Sobrenome</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="space-y-1.5">
            <label className="text-xs font-black text-slate-400 px-1 uppercase tracking-tighter">Celular *</label>
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-black text-slate-400 px-1 uppercase tracking-tighter">E-mail</label>
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-black text-slate-400 px-1 uppercase tracking-tighter">CEP *</label>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            <label className="text-xs font-black text-slate-400 px-1 uppercase tracking-tighter">Canal de Origem</label>
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-black text-slate-400 px-1 uppercase tracking-tighter">Pré-vendedor</label>
            {isVendedor && !isAdm ? (

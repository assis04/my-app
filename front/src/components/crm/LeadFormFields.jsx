      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            <label className="text-sm font-black text-(--text-muted) px-1 tracking-tight">Nome *</label>
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-black text-(--text-muted) px-1 tracking-tight">Sobrenome</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="space-y-1.5">
            <label className="text-sm font-black text-(--text-muted) px-1 tracking-tight">Celular *</label>
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-black text-(--text-muted) px-1 tracking-tight">E-mail</label>
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-black text-(--text-muted) px-1 tracking-tight">CEP *</label>

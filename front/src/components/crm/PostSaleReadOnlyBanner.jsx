  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        <h4 className="text-sm font-black text-amber-900 uppercase tracking-tight mb-0.5">
        ...
        <p className="text-sm text-amber-700 font-medium leading-relaxed">
          ...
          <code className="mx-1 px-1.5 py-0.5 bg-amber-100 rounded text-xs font-mono">
            crm:leads:edit-after-sale
          </code>

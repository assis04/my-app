      ...
      {OPTIONS.map(({ value: optValue, label, Icon, activeClasses, idleClasses }) => {
        ...
        return (
          <button
            ...
            className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-base font-bold border transition-all active:scale-95 shadow-sm tracking-tight disabled:opacity-50 disabled:cursor-not-allowed ${
